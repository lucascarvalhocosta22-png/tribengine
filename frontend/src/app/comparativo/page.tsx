...
export default function ComparativoPage() {
  ...
  const oldLabels: any = { cfop_5102: 'ICMS 4,15% + PIS/COFINS 3,65%', cfop_5405: 'ICMS 0% + PIS/COFINS 0%', outros_cfop: 'ICMS 4,15% + PIS/COFINS 3,65%' }
      ...
      <div className="mt-6 card">
        ...
        <div className="text-sm text-gray-300 space-y-2">
          ...
          <ul className="list-disc list-inside text-gray-400 ml-4 space-y-1">
            <li>CFOP 5102 (venda normal): ICMS <strong className="text-white">4,15%</strong> + PIS/COFINS <strong className="text-white">3,65%</strong> = 7,80%</li>
